...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    BOOST_FOREACH(const COutput& out, vOutputs) {
        ...
        // Amount
        nAmount += out.tx->vout[out.i].IsZerocoinMint() ? out.nAmount : out.tx->vout[out.i].nValue;
...
void CoinControlDialog::updateView()
{
    ...
    BOOST_FOREACH(const PAIRTYPE(QString, std::vector<COutput>)& coins, mapCoins) {
        ...
        BOOST_FOREACH(const COutput& out, coins.second) {
            ...
            // amount
            itemOutput->setText(COLUMN_AMOUNT, NavCoinUnits::format(nDisplayUnit, out.tx->vout[out.i].IsZerocoinMint() ? out.nAmount : out.tx->vout[out.i].nValue));
            itemOutput->setText(COLUMN_AMOUNT_INT64, strPad(QString::number(out.tx->vout[out.i].IsZerocoinMint() ? out.nAmount : out.tx->vout[out.i].nValue), 15, " ")); // padding so that sorting works correctly
