...
public:
    ...
    bool ReadZerocoinAccumulator(uint256 accumulatorChecksum, std::pair<std::pair<uint256, uint256>,std::vector<std::pair<libzerocoin::CoinDenomination,CBigNum>>> &accumulatorMap);
    bool WriteZerocoinAccumulator(uint256 accumulatorChecksum, std::pair<std::pair<uint256, uint256>,std::vector<std::pair<libzerocoin::CoinDenomination,CBigNum>>> accumulatorMap);
