...
bool CBlockTreeDB::ReadZerocoinAccumulator(uint256 accumulatorChecksum, std::pair<std::pair<uint256, uint256>,std::vector<std::pair<libzerocoin::CoinDenomination,CBigNum>>> &accumulatorMap)
{
    return Read(make_pair(DB_ZEROCOIN_ACCUMULATOR, accumulatorChecksum), accumulatorMap);
}

bool CBlockTreeDB::WriteZerocoinAccumulator(uint256 accumulatorChecksum, std::pair<std::pair<uint256, uint256>,std::vector<std::pair<libzerocoin::CoinDenomination,CBigNum>>> accumulatorMap)
{
